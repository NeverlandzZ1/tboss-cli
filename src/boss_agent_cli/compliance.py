...
_POLICY_DEFINITIONS = {
	...
	"recruiter-recommend": ("platform_collection", "candidate_profile", "推荐牛人列表涉及个人信息与平台采集。"),
	"recruiter-chat-start": ("platform_write", "communication", "向推荐候选人发起沟通属于平台写操作。"),
	...
	"recruiter-accept-resume": ("platform_write", "candidate_profile", "同意接收候选人附件简历涉及个人信息授权。"),
